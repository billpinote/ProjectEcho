...
class IcaoValidationRulesTest extends TestCase
{
    ...
    {
        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateAircraftIdentification('N12345'));
        $this->assertFalse(\App\Rules\IcaoFlightPlanRules::validateAircraftIdentification('N-12345'));

        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateFlightRules('I'));
        $this->assertFalse(\App\Rules\IcaoFlightPlanRules::validateFlightRules('IFR'));

        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateTypeOfFlight('S'));
        $this->assertFalse(\App\Rules\IcaoFlightPlanRules::validateTypeOfFlight('SC'));

        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateWakeTurbulenceCategory('H'));
        $this->assertFalse(\App\Rules\IcaoFlightPlanRules::validateWakeTurbulenceCategory('X'));

        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateAerodrome('KJFK'));
        $this->assertFalse(\App\Rules\IcaoFlightPlanRules::validateAerodrome('JFK'));

        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateCruisingSpeed('N450'));
        $this->assertFalse(\App\Rules\IcaoFlightPlanRules::validateCruisingSpeed('450'));

        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateFlightLevel('F250'));
        $this->assertTrue(\App\Rules\IcaoFlightPlanRules::validateFlightLevel('VFR'));
        $this->assertFalse(\App\Rules\IcaoFlightPlanRules::validateFlightLevel('FL250'));
    }
}
